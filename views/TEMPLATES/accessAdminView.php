...
<section >
    <form action="?action=admin" class="d-flex flex-column justify-content-center m-2 border border-dark w-25 m-auto bg-light rounded p-2">
        ...
        <input type="submit" value="Go Admin" class="btn btn-warning">
    </form>
</section>
