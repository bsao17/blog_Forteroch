...
<body>
    <div class="globalBody position-relative">
        <header>
            <div class=" d-flex flex-column justify-content-center align-items-center m-0" id="banner">
                ...
                <section class="text-dark w-25">
                    ...
                    <div class=" p-0 bg-success rounded mb-2">
                        <p class="h6 bg-light p-1 text-center m-1 border border-dark"><span class="h4 text-secondary">
                                <i class="fas fa-user-circle"></i></span><span class="h4">
                                <strong><?php echo ' | '.$_SESSION['login']; ?></strong> :Logued !</span></p>
                    </div>
                    <a href="<?php echo '?action=accueil'; ?>" class="btn btn-light mb-2 ">
