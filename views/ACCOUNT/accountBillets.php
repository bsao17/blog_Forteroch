...
<section class="m-2 p-2 border border-light rounded" id="billet">
    <?php
        foreach($post as $value){
            echo "<span class='card p-3' id='{$value['ID']}'>".$value['content']."<a href='#' class='btn btn-outline-light m-auto w-25'><i class='fas fa-hand-point-up'></i></a></span><hr class='border border-light bg-danger p-2 rounded-circle'>";
        }
    ?>
